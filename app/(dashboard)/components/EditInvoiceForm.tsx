...
const itemSchema = Yup.object({
  ...
  unitPrice: Yup.number()
    .min(1)
    .required("Price must be a non-negative number"),
});
                  ...
                  <div className="w-full flex gap-5 ">
                    <div className="w-full space-y-3">
                      <div id="" className="space-y-1">
                        ...
                        <input
                          className={`appearance-none border rounded w-full py-2 px-3 text-gray-100 bg-gray-800 leading-tight placeholder:text-gray-500 focus:outline-none ${
                            errors?.seller?.name
                              ? "border-red-500"
                              : "border-slate-500"
                          }`}
